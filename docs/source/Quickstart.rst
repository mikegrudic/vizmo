...
Example of using ``vizmo`` to solve for collisional ionization
...
.. code:: ipython3
    ...
    from vizmo.processes import CollisionalIonization, GasPhaseRecombination
...
Let’s break down what happened there. First, vizmo is generating the
